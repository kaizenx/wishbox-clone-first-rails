...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { feeid: @gallery.feeid, image: @gallery.image, name: @gallery.name, productid: @gallery.productid }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { feeid: @gallery.feeid, image: @gallery.image, name: @gallery.name, productid: @gallery.productid }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
