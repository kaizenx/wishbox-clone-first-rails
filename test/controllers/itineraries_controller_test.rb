...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { ProductId: @itinerary.ProductId, TripId: @itinerary.TripId, UserId: @itinerary.UserId }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { ProductId: @itinerary.ProductId, TripId: @itinerary.TripId, UserId: @itinerary.UserId }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
